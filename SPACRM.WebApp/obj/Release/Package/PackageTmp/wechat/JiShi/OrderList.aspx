<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="SPACRM.WebApp.wechat.JiShi.OrderList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="meiheader">
            <div class="askboxcon">
                ...
                <h2>
                    <select class="dropdown-select-nav" disabled>
                        <option><%=DateTime.Now.ToString("yyyy年MM月") %></option>
        ...
        <div class="meiWapper mei-index-bottom date-index-Top">
            ...
            <nav class="inner tabbar">
                ...
                <a class="active" href="orderlist.aspx">
                    <div class="icon"></div>
                    <p>订单</p>
                </a>
                <a href="wo.aspx">
...
<script>
    ...
    $('#order-datelist').find('.swiper-slide').on('click', function () {
        location = "orderlist.aspx?rq=" + $(this).find('em').attr("rq");
    ...
    function updatezt(id, zt, msg) {
        ...
        $.MsgBox.Confirm("小时光", "是否确认" + msg, function () {
            $.ajax({
                url: 'OrderList.aspx?para=SZ&zt=' + zt + "&id=" + id,
