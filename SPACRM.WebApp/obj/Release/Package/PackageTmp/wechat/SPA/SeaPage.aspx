<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeaPage.aspx.cs" Inherits="SPACRM.WebApp.wechat.SPA.SeaPage" %>
...
<head runat="server">
    ...
    <style>
        * {
        ...
        ul, li, h1, h2, h3, h4, h5, p, input, dl, dt, dd, table, th, td, ol, form, bdo, em, i {
            margin: 0;
            padding: 0;
            list-style: none;
        }
        ...
        .liucheng {
            ...
            height: 3rem;
            display: block;
            background: url(image/liucheng.png) no-repeat center center;
        ...
        .chanpintu img {
            ...
            display: block;
            min-height: 9rem;
            box-shadow: 0 5px 10px #b07540;
        }

        .lipinma {
            margin: 10px;
            background: #fff;
            border-top: 1px solid #b07540;
            border-bottom: 1px solid #b07540;
            padding: 10px 0 20px;
            margin-bottom: 20px;
            box-shadow: 0 4px 10px #b07540;
        }
            ...
            .lipinma h2 {
                ...
                .lipinma h2 span.icon01 {
                    background: url(image/lipin.png) no-repeat 0 center;
                    background-size: 30px 35px;
                    padding-left: 40px;
                }

                .lipinma h2 span.icon02 {
                    background: url(image/huodongxuzhi.png) no-repeat 0 center;
                    background-size: 30px 35px;
                    padding-left: 40px;
                }
        ...
        .jiantou {
            width: 20px;
            height: 20px;
            background: url(image/jiantou3.png) no-repeat center 0;
...
<body>
    <form id="form1" runat="server">
        <div class="banner">
            ...
            <div class="daojishi">
                <p><span>2位名额</span> | <span><%=personcount+300 %>人已参与</span></p>
        ...
        <div class="lipinma">
            ...
            <ul>
                ...
                <%
                  ...
                  {
                      %>
                <%if (a == 27567258 || a == 27372289) { zj = true; } %>
                <%
        ...
        <div class="lipinma">
            ...
            <ul>
                <li><span>27567258</span></li>
                <li><span>27372289</span></li>
            </ul>
        </div>
        ...
        <div class="lipinma">
            ...
            <div class="huodong">
                <strong>开奖流程</strong>
                <p>
                    1、活动结束时的上证指数为：3217.57<br />
                    2、乘以100后为：321757<br />
                    3、平方之后为：103527567049<br />
                    4、取最后八位为：27567049<br />
                    5、得出最接近此八位数的中奖码为27567258、27372289
        ...
        <div class="lipinma">
            ...
            <div class="huodong">
                <strong>活动规则</strong>
                <p>
                    本期活动时间：2017年6月23日00:00:00 - 7月6日23:59:59
                    <br />
                    本期幵奖时间：7月7日15:00<br />
                ...
                <p>
                    活动时间2017年6月23日00:00:00 - 7月6日23:59:59,取2017-07-7收盘时候上证指数3273.83,该指数乘以100为327383,取平方数为107179628689,取后8位数为79628689,与该数字最接近的即为中奖号码。
                </p>
                <strong>获奖通知</strong>
                <p>
                    请留意抽奖时间，幵奖后24小时内我们将联系绑定的微信，获奖人需根据获奖通知提供手机号码，同时小时光SPA公告、推文会显示中奖ID。获奖商品保留30天，若因获奖用户取消关注、长期不留意小时光SPA推送等原因无法取得联系，将自动取消领奖，请一定保持可联络状态。谢谢配合。
                </p>
            </div>
        </div>
    </form>
            ...
            if (result.state == 0) {
                ...
                wx.ready(function () {
                    ...
                    wx.onMenuShareTimeline({ //分享朋友圈
                        title: "【免费赢香邂格蕾悦颜香氛】刘诗诗婚礼同款人气花果香！", // 分享标题
                        link: result.link, // 分享链接
                        imgUrl: "http://www.xsgapp.com/assets/img/song.jpg", // 分享图标
                        success: function () {
                            // 用户确认分享后执行的回调函数
                            zf();
                        },
