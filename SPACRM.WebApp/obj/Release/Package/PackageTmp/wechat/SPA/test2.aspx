<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test2.aspx.cs" Inherits="SPACRM.WebApp.wechat.SPA.test2" %>
<!DOCTYPE html>
<html>
    ...
    <body>
        <video id="video" style="width:40%;" height="480" autoplay></video>
        <video  style="width:40%;" height="480" controls="controls">
  <source src="movie.ogg" type="video/ogg">
  <source src="https://petgohome.meijiewd.com/api/guo111.mp4" type="video/mp4">
