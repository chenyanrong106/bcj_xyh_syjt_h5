<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="crowdpay.aspx.cs" Inherits="SPACRM.WebApp.wechat.SPA.crowdpay" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="meiheader">
            <div class="askboxcon">
                <a href="javascript:history.go(-1);"><span class="icon-left"></span></a>
                <h2>订单支付</h2>
        ...
        <div class="meiWapper">
            <div class="order-content">
                <div class="pay-order-info">
                    ...
                    <p><strong>支付金额：</strong> <bdo>￥<%=order.TotalPrice %></bdo></p>
                    <%} %>
                </div>
                ...
                <div class="pay-order-info pay-order-paylei">
                    <h2>联系方式（方便客服后续联系您）</h2>
                    <p>
                        <span>
                            <input type="tel" id="txtphone" placeholder="请输入手机号码" style="width: 90%; height: 42px; background: #fff; display: inline-block; border: none; margin: 0; padding: 0; font-size: 1.2em;" /></span><strong style="width: 60px;">手机号码</strong>
                    </p>
                </div>
            ...
            <%--<%} %>--%>
            <input type="hidden" id="vtime" value="<%=DateTime.Now.AddMinutes(15).ToString("yyyy-MM-dd HH:mm:ss") %>" />
...
<script>
    ...
    $("#bookall").click(function () {
        if ($("#txtphone").val().length != 11) {
            $.MsgBox.Alert("小时光", "请填写手机号码，以便我们客服联系。");
        }
        else if ($(".pay-order-info.pay-order-paylei i.icon-radio-f").attr("id")) {
            //alert($(".pay-order-info.pay-order-paylei i.icon-radio-f").attr("id"));
            $("#bookall").hide();
            $.post("crowdpay.aspx?para=tj", {
