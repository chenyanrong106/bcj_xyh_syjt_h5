...
.share{width:100%; height:100%; max-width:640px; display:block; background:url(image/jianou.png) no-repeat 90% 20px #333; background-size:70px 47px; position:absolute; left:0; top:0; z-index:999;}
...
.sharebox p{ padding:10px; font-size:18px; color:#fff; line-height:30px; background:url(image/liulanqi.jpg) no-repeat center bottom; padding-bottom:90px; background-size:280px 82px;}
</style>
