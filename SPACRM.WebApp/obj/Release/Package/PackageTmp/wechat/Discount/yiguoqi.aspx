<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yiguoqi.aspx.cs" Inherits="SPACRM.WebApp.wechat.Discount.yiguoqi" %>
...
<body class="bgcolor">
    <form id="form1" runat="server">
        ...
        <div class="order-tag-item">
            ...
            <a href="yiguoqi.aspx">
                <ol><span class="curbtn">已过期(<%=mydis.ygq %>)</span></ol>
            </a>
            <%} %>
        </div>
        <!--end header-->
