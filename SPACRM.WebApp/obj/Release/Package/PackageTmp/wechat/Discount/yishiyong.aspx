<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yishiyong.aspx.cs" Inherits="SPACRM.WebApp.wechat.Discount.yishiyong" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="order-tag-item">
            <%if (mydis != null)
              { %>
            <a href="index.aspx">
                <ol><span>未使用(<%=mydis.wsy %>)</span></ol>
            </a>
            <a href="yishiyong.aspx">
                <ol><span class="curbtn">已使用(<%=mydis.ysy %>)</span></ol>
            </a>
            <a href="yiguoqi.aspx">
