    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '顾客ID', name: 'CUST_ID', sortable: false, hide: true, align: 'left' },
                    { display: '时间', name: 'TRANS_DATE', sortable: false, align: 'left' },
                    { display: '顾客姓名', name: 'CUST_NAME', sortable: false, align: 'left', process: CustDetail },
                    { display: '订单编号', name: 'ORDER_NO', sortable: false, align: 'left', process: OrderDetail },
        ...
        function OrderDetail(value, cell) {
            ...
            href = "../Order/OrderB.do?cid=" + cell[2] + "&oid=" + cell[0];
