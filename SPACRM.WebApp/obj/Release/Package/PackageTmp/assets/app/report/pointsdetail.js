    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '转入积分', name: 'deposit', sortable: false, align: 'left', sum: true },
                    { display: '积分使用', name: 'RealAmt', sortable: false, align: 'left', sum: true },
                    { display: '余额', name: 'BALANCE', sortable: false, align: 'left', sum: true },
