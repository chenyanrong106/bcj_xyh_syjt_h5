...
; (function (window, undefined, $) {
    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    { display: '会员编号', name: 'CUST_ID', sortable: true, hide: true, align: 'left', iskey: true },
                    { display: '会员姓名', name: 'CNAME', sortable: true, align: 'left', process: CustDetail },
                    { display: '表面号', name: 'CARD_NO', sortable: false, align: 'left'},
                    { display: '分店名称', name: 'STORE_NAME', sortable: false, align: 'left' },
                    { display: '时间', name: 'TIME_SCOPE', sortable: false, align: 'left' },
                    { display: '消费金额', name: 'REAL_CONSUMING', sortable: false, align: 'left', sum: true },
                    { display: '消费次数', name: 'TOTAL_COUNT', sortable: false, align: 'left', sum: true }
            ],
            sortname: "Id",
            sortorder: "ASC",
            title: false,
