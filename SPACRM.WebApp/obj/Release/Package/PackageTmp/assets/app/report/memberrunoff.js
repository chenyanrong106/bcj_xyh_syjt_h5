    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                ...
                { display: '表面号', name: 'CARD_NO', sortable: false, align: 'left' },
                { display: '手机号', name: 'MOBILE', sortable: false, align: 'left' },
                { display: '性别', name: 'GENDER', sortable: false, align: 'left' },
                { display: '地址', name: 'ADDRESS', sortable: false, align: 'left' },
                { display: '最后消费日期', name: 'LAST_CONSUME_DATE', sortable: false, align: 'left' },
                { display: '有效期', name: 'END_DATE', sortable: false, align: 'left', process: formatDate },
                { display: '实际金额', name: 'BALANCE', sortable: false, align: 'left', sum: true }
            ],
            sortname: "Id",
            sortorder: "ASC",
            title: false,
        ...
        function CustDetail(value, cell) {
            ...
            href = "../Customer/View360.do" + "?cid=" + cell[0];
