    ...
    $(document).ready(function () {
        ...
        function PGRID() {
            var gridopt = {
                ...
                colModel: [
                        ...
                        { display: '产品编号', name: 'PROD_SKU', sortable: false, align: 'left' },
        ...
        function SGRID() {
            ...
            var gridopt2 = {
                ...
                colModel: [
                        ...
                        { display: '项目英文名称', name: 'EN_NAME', sortable: false, align: 'left' },
                        { display: '分店名称', name: 'STORENAME', sortable: false, align: 'left' },
        ...
        function CGRID() {
            var gridopt3 = {
                ...
                colModel: [
                    { display: '卡级编号', name: 'ID', sortable: true, align: 'left', iskey: true },
                    { display: '卡级名称', name: 'CARD_NAME', sortable: false, align: 'left' },
                    { display: '分店名称', name: 'STORENAME', sortable: false, align: 'left' },             
                    { display: '数量', name: 'CARD_COUNT', sortable: false, align: 'left', sum: true },
                    { display: '单价', name: 'SALE_AMT', sortable: false, align: 'left', sum: true },
