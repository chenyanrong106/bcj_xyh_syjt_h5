; (function (window, undefined, $) {
    $(document).ready(function () {
        ...
        if ($("#IS_ALLCUST:checked").attr("value") == "0") {
            $("#DivCUST_GROUP_ID").hide();
        }
        else {
            $("#DivCUST_GROUP_ID").show();
        }
        //适用顾客
        util.CustomerRangeclick = function (object) {
            if (object == 1) {//适用所有顾客
                $("#DivCUST_GROUP_ID").hide();
            } else {//适用部分顾客
                $("#DivCUST_GROUP_ID").show();
        ...
        //适用顾客
        if ($("#IS_ALLCUST:checked").attr("value") == "0") {//所有客户
            $("#DivCUST_GROUP_ID").hide();
        }
        else {
            $("#DivCUST_GROUP_ID").show();
        ...
        $("input[name='IS_ALLCUST']").change(function () {
            if ($("#IS_ALLCUST:checked").attr("value") == "0") {
                $("#DivCUST_GROUP_ID").hide();
                $("#ISALLCUST").val(0);
            }
        ...
        util.DISCOUNT_RATE_ONKEYUP = function (obj) {
            ...
            if (obj.value > 1) {
                _showInfoMessage("优惠折扣不能大于1！", 'error');
                obj.value = 1;
                return false;
            }
