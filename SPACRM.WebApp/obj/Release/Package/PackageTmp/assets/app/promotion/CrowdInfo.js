    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '昵称', name: 'NiceName', width: "5%", sortable: false, align: 'left' },
                    { display: '城市', name: 'City', width: "28%", sortable: false, align: 'left' },
                    { display: '标题', name: 'Title', width: "12%", sortable: false, align: 'left' },
                    { display: '目标', name: 'MB', width: "13%", sortable: false, align: 'left' },
        ...
        util.Edit = function (id) {
            window.location.href = options.editUrl + "?id=" + id;
