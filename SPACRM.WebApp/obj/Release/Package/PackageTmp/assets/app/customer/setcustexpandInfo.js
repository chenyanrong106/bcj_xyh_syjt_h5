    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '名称', name: 'EX_NAME', width: "55%", sortable: false, align: 'left' },
                    { display: '编号', name: 'EX_CODE', width: "15%", sortable: false, align: 'left' },
                    { display: '排序', name: 'EX_SEQ', width: "10%", sortable: false, align: 'left' },
                ...
                id: id
                 ...
                 function (ret) {
                     if (ret && ret.status == 0) {
                         ...
                         $("#ID").val(ret.data.ID);
                         $("#EX_CODE").val(ret.data.EX_CODE);
                         $("#EX_NAME").val(ret.data.EX_NAME);
                         $("#PARENT_NAME").html(ret.data.PARENT_NAME);
                         $("#EX_SEQ").val(ret.data.EX_SEQ);
                         $("#PARENT_ID").val(ret.data.PARENT_ID);
                         $("#EX_TYPE").val(ret.data.EX_TYPE);
                         $("#CHOICE_TYPE").val(ret.data.CHOICE_TYPE);                 
                         $("#EX_CODE").attr("readonly", "readonly");
