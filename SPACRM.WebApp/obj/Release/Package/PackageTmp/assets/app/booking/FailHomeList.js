    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '预约到家时间', name: 'BEGIN_END', sortable: false, align: 'left', process: processBE },
        ...
        function processBE(value, cell) {
            ...
            var day = cell[11].split(" ")[0]  //预约天
            var startTime = cell[11].split(" ")[1].substring(0, 5);
            var endTime = cell[12].split(" ")[1].substring(0, 5);
