// ------------------------------
// Page Preloader 效果 add by liuliyuan 2014-5-19
// ------------------------------

jQuery(window).load(function () {

    // Page Preloader
    jQuery('#loading_status').fadeOut();
...
$('#btnBirthdayShow').click(function (event) {
...
//提示消息
function _showInfoMessage(title,type)
{
    //title 显示标题
    //type 提示类型 info, succsee,error 
    $.pnotify({
        title: title,
        type: type
    });
