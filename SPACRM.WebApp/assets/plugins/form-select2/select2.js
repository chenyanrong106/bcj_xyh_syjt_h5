...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function (data, container) {
            
            return "<span style='color:#7B7B7B;font-size:12px;' >未查询到相关信息</span>";
        },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "<span style='color:#7B7B7B;font-size:12px;' >至少输入" + n + " 个字查询</span>" + (n == 1 ? "" : ""); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Please delete " + n + " character" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "You can only select " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Loading more results..."; },
        formatSearching: function () { return "<span style='color:#7B7B7B;font-size:12px;' >正在查询...</span>"; },
