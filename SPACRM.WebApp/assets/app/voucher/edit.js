...
; (function (window, undefined, $) {
    $(document).ready(function () {
        ...
        $('input[name=IS_ALLDAY]').change(function () {
            var _value = this.value;
            if (_value == '0') {
                $('#showAllDay').show('slow');
            } else {
                $('#showAllDay').hide('slow');
            }
        });
        ...
        //type:1-项目；2-产品；3-门店
        function PostSave(postData, url, type) {
            if (_submiting) {
