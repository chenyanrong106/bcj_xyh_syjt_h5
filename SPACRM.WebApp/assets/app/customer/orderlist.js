; (function (window, undefined, $) {
    $(document).ready(function () {
        var gridopt = {
            url: options.linkUrl+"&TYPE=OrderList",
            colModel: [
                    { display: '编号', name: 'ID', width: "5%", sortable: true, hide: true, align: 'left', iskey: true },
                    { display: '订单日期', name: 'TRANS_DATE', width: "9%", sortable: false, align: 'left', process: formatDate },
                    { display: '顾客编号', name: 'CUST_ID', sortable: true, hide: true, align: 'left' },
                    { display: '订单号', name: 'ORDER_NO', width: "15%", sortable: false, align: 'left', process: OrderDetail },
