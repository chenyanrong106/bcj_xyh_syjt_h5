; (function (window, undefined, $) {
    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    { display: '日期', name: 'rq', width: "5%", sortable: true, hide: false, align: 'left', iskey: true },
                    { display: '应付', name: 'yf', width: "5%", sortable: false, hide: false, align: 'left', sum: true },
                    { display: '实付', name: 'sf', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '储值卡充值', name: 'cz', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '身享受', name: 'xm519', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '慢一刻', name: 'xm520', width: "5%", sortable: false, hide: true, align: 'left', sum: true },
                    { display: '心悠然', name: 'xm521', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '半日闲', name: 'xm522', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '刮痧', name: 'xm523', width: "5%", sortable: false, align: 'left', hide: true, sum: true },
                    { display: '刮痧', name: 'xm524', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '拔罐', name: 'xm525', width: "5%", sortable: false, align: 'left', sum: true },
                    { display: '付款状态', name: 'xm526', width: "5%", hide: true, sortable: false, align: 'left', hide: true, sum: true },
                    { display: '试营业尊享', name: 'xm527', width: "5%", sortable: false, align: 'left    ', sum: true },
                    { display: '采耳', name: 'xm528', width: "5%", sortable: false, align: 'left    ', sum: true },
                    { display: '操作', name: 'xm529', width: "5%", sortable: false, align: 'left    ', hide: true, sum: true },
                    { display: '在线买单', name: 'zxmd', width: "5%", sortable: false, align: 'left    ', sum: true }
            ],
            sortname: "Id",
            sortorder: "DESC",
            title: false,
        ...
        $("#STORE_ID").change(function () {
            if ($(this).val() != "") {
                $.post("/Employee/GetEmployeeByType.do",
                    {
                        USER_TYPE: 2,
                        STORE_ID: $(this).val(),
                        EMPLOYEE_ID: 0
                      ...
                      function (data) {
                          $("#STAFF_ID").html("<option>全部</option>" + data.data); //console.log(data);

                      },
               "json"
              );
            } else {
                $("#STAFF_ID").html("<option>全部</option>");
            }
        });
