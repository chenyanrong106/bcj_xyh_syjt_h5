    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '会员姓名', name: 'CUST_NAME', sortable: false, align: 'left', process: CustDetail },
                    { display: '时间', name: 'TRANS_DATE', sortable: false, align: 'left' },
                    { display: '项目名称', name: 'PROD_NAME', sortable: false, align: 'left' },
                    { display: '技师', name: 'EMPLOYEE_NAME', sortable: false, align: 'left' },
                    { display: '原价', name: 'PROD_PRICE', sortable: false, align: 'left', sum: true },
                    { display: '现价', name: 'PROD_AMT', sortable: false, align: 'left', sum: true },
                    { display: '数量', name: 'PROD_CNT', sortable: false, align: 'left' },
                    { display: '金额', name: 'PAY_AMT', sortable: false, align: 'left', sum: true }
            ],
            sortname: "Id",
            sortorder: "ASC",
            title: false,
