    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: 'SKU', name: 'SKU', width: "5%", sortable: false, align: 'left' },
                    { display: '名称', name: 'NAME', width: "28%", sortable: false, align: 'left' },
                    { display: '所属大类', name: 'BCATE', width: "12%", sortable: false, align: 'left' },
                    { display: '所属小类', name: 'SCATE', width: "13%", sortable: false, align: 'left'},
                    { display: '持续时长(分钟)', name: 'TIME_LEN', width: "12%", sortable: false, align: 'left' },
                    { display: '价格', name: 'PRICE', width: "8%", sortable: false, align: 'left' },
