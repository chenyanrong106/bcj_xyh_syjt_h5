    ...
    $(document).ready(function () {
        ...
        function TreeNode_Click(data) {
            ...
            if (data.pid == "00000000-0000-0000-0000-000000000000") {
                ...
                if (data.text == "产品" || data.text == "项目") {
                    $("#btnAdd").html(" <i class='fa fa-plus'></i> 新增大类");
                }
                else {
                    $("#btnAdd").html("<i class='fa fa-plus'></i> 新增小类");
                }
                $("#h4Dict").html(data.text);
                $("#PARENT_ID").val(data.id);
                $("#PARENT_NAME").html(data.text);
                $("#PROD_TYPE").val(data.org_id);
                ...
                id: id
                 ...
                 function (ret) {
                     if (ret && ret.status == 0) {
                         ...
                         _showInfoMessage("数据库中没有此类别，请刷新重试！", 'error');
                     }
                 },
                 "json"
           );
