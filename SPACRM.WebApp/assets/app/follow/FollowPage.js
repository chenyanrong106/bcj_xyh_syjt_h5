; (function (window, undefined, $) {
    $(document).ready(function () {
        var gridopt = {
            url: options.queryRightUrl + "?ORDER_ID=" + getQueryString("ID"),
            colModel: [
                    { display: '编号', name: 'RIGHT_ID', width: "0", sortable: false, hide: true, align: 'left', iskey: true },
                    { display: '产品名称', name: 'PROD_NAME', width: "15%", sortable: false, align: 'left' },
                    { display: '产品数量', name: 'PROD_CNT', width: "10%", sortable: false, align: 'left' },
                    { display: '产品单价', name: 'PROD_PRICE', width: "10%", sortable: false, align: 'left' },
                    { display: '产品金额', name: 'PROD_AMT', width: "10%", sortable: false, align: 'left' },
