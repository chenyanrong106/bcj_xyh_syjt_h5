    ...
    $(document).ready(function () {
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '类型', name: 'PAYMODE', width: "10%", sortable: false, align: 'left' },
                    ...
                    { display: '唯一CODE', name: 'CODE', width: "10%", sortable: false, align: 'left' },
                   { display: 'ORG_ID', name: 'ORG_ID', width: "0", sortable: true, hide: true, align: 'left' },
        ...
        function processOp(value, cell) {
            var ops = [];
            //0现金，1银联POS，2应收帐款，3代金券，5会员卡,999疗程支付
            if (cell[7] != 0 ) {
        ...
        util.Edit = function (id) {
            $.getJSON(options.editUrl, { id: id }, function (res) {
                if (res != null && res.status == 0) {
                    ...
                    //if (data.data.TYPE == 0)
                    //{
                    //    $("#PAY_TYPE").append("<option value='0' selected='selected'>现金</option>");
