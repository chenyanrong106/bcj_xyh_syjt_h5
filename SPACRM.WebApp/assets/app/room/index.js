    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '房间编号', name: 'ROOM_NO', width: "10%", sortable: false, align: 'left' },
                    { display: '房间名称', name: 'NAME', width: "10%", sortable: false, align: 'left' },
                    { display: '所属门店', name: 'STORE_NAME', width: "10%", sortable: false, align: 'left' },
                    { display: '床位数', name: 'BED_NUM', width: "10%", sortable: false, align: 'left' },
                    { display: '说明', name: 'REMARK', width: "20%", sortable: false, align: 'left' },
        ...
        function processOp(value, cell) {
            var ops = [];
            ops.push("&nbsp;<a title='编辑房间信息' class='abtn' href='javascript:;'  onclick=\"util.Edit('", value, "')\"><i class='fa fa-edit' ></i>编辑</a>");
            ops.push("&nbsp;&nbsp;<a title='删除房间信息' class='abtn' href='javascript:;'  onclick=\"util.Delete('", value, "','", cell[1], "')\"><i class='fa fa-trash-o' ></i>删除</a>");
            return ops.join("");
        }
