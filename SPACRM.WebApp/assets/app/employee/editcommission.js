; (function (window, undefined, $) {
    ...
    $(document).ready(function () {
        ...
        function processTcfs(value, cell, rowid) {
            ...
            //else
            ops.push("&nbsp;<select class='discounts_input' style=\"text-align:right;width:140px;height=30px\" name=\"" + cell[3] + "\">");
        ...
        function processTcje(value, cell, rowid) {
            var ops = [];
            ops.push("&nbsp;<input class='discounts_input' style=\"text-align:right;width:80px\" id=\"COMM_AMT_" + cell[3] + "_" + rowid + "\" type=\"text\" /><span  style='display:none'>%</span>");
        ...
        function processTcje1(value, cell, rowid) {
            var ops = [];
            ops.push("&nbsp;<input class='discounts_input' style=\"text-align:right;width:80px\" id=\"COMM_DK_" + cell[3] + "_" + rowid + "\" type=\"text\" /> <span  style='display:none' >%</span>");
            return ops.join("");
        }
        ...
        var gridoptFwxm = {
            ...
            colModel: [
                    ...
                    { display: '服务编号', name: 'PROD_ID', width: "0%", sortable: true, hide: true, align: 'left' },
                    { display: '名称', name: 'PROD_NAME_ALL', width: "45%", sortable: false, align: 'left' },
                    { display: '佣金类型', name: 'PROD_TYPE', width: "0%", sortable: false, hide: true, align: 'left' },
                    { display: '提成方式', name: 'COMM_TYPE', width: "20%", sortable: false, align: 'left', process: processTcfs },
        ...
        var gridoptCp = {
            ...
            colModel: [
                      { display: '编号', name: 'ID', width: "0%", sortable: true, hide: true, align: 'left', iskey: true },
                      { display: '产品编号', name: 'PROD_ID', width: "0%", sortable: true, hide: true, align: 'left' },
                      { display: '名称', name: 'PROD_NAME_ALL', width: "45%", sortable: false, align: 'left' },
        ...
        var gridoptHyk = {
            ...
            colModel: [
                     { display: '编号', name: 'ID', width: "0%", sortable: true, hide: true, align: 'left', iskey: true },
                     { display: '卡级编号', name: 'PROD_ID', width: "0%", sortable: true, hide: true, align: 'left' },
                     { display: '名称', name: 'PROD_NAME_ALL', width: "45%", sortable: false, align: 'left' },
                     { display: '佣金类型', name: 'PROD_TYPE', width: "0%", sortable: true, hide: true, align: 'left' },
