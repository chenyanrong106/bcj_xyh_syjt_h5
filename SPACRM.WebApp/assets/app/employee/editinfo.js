; (function (window, undefined, $) {
    ...
    $("#btnSaveXcyfl").click(function (e) {
        ...
        else if ($("#SALARY_TYPE3:checked").val() == 1) {
        ...
        else if ($("#SALARY_TYPE4:checked").val() ==3) {
    ...
    (
        {
            ...
            fileElementId: 'fHeadImage', //文件上传空间的id属性  <input type="file" id="file" name="file" />
            ...
            success: function (data, status, Message)  //服务器成功响应处理函数
            {
                ...
                $("#Img").val(data.Data.FILE_URL);
                $("#iImg").attr("src", data.Data.FILE_URL);
