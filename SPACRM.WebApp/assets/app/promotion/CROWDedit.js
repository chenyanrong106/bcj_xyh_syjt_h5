...
; (function (window, undefined, $) {
        ...
        valid: function (form) {
            ...
            FormSubmit(form, function (res) {
                if (res.status == 0) {
                    ...
                    location = "crowdinfo.do";
                }
            })
        }
    });

    var ue = UE.getEditor('TW1');
    UE.getEditor('TW2');
    UE.getEditor('TW3');
    UE.getEditor('TW4');
    ...
    $("#btnStoreCancel").click(function (e) {
        window.location.href = options.indexUrl;
    })
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.status == 0) {
                    ...
                    window.location.href = "/Service/index.do";
                }
                else {
...
function ajaxFileUpload(id) {
    ...
    (
        {
            url: '/Image/UploadImage.do', //用于文件上传的服务器端请求地址
            type: 'post',
            data: { Id: '123', name: 'lunis' }, //此参数非常严谨，写错一个引号都不行
            secureuri: false, //一般设置为false
            fileElementId: 'f'+id, //文件上传空间的id属性  <input type="file" id="file" name="file" />
            ...
            success: function (data, status, Message)  //服务器成功响应处理函数
            {
                ...
                $("#" + id).val(data.Data.FILE_URL);
                $("#i" + id).attr("src", data.Data.FILE_URL);
