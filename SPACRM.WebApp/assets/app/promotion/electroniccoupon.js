    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                    ...
                    { display: '有效期', name: 'BEGIN_DATE', width: "20%", sortable: false, align: 'left', process: formatDate0 },
                    ...
                    { display: '适用顾客', name: 'CUST_GROUP_NAME', width: "10%", sortable: false, align: 'left' },
        ...
        var gridopt2 = {
            ...
            colModel: [
                    ...
                    { display: '创建时间', name: 'CREATE_DATE', width: "10%", sortable: false, align: 'left', process: formatDate },
                    { display: '有效期', name: 'BEGIN_DATE', width: "18%", sortable: false, align: 'left', process: formatDate2 },
                    { display: '有效期', name: 'END_DATE', width: "0", sortable: false, hide: true, align: 'left' },
        ...
        var gridopt3 = {
            ...
            colModel: [
                    ...
                    { display: '创建时间', name: 'CREATE_DATE', width: "10%", sortable: false, align: 'left', process: formatDate },
                    { display: '有效期', name: 'BEGIN_DATE', width: "20%", sortable: false, align: 'left', process: formatDate3 },
                    { display: '有效期', name: 'END_DATE', width: "0", sortable: false, hide: true, align: 'left' },
                    { display: '优惠折扣', name: 'DISCOUNT_RATE', width: "8%", sortable: false, align: 'left' },
        ...
        function formatDate0(value, cell) {
            if (value) {
                return value.split(" ")[0].replace("/", "-").replace("/", "-") + " 至 " + cell[5].split(" ")[0].replace("/", "-").replace("/", "-");
            }
            else {
                return "-";
            }
        ...
        function formatDate1(value, cell) {
            if (value) {
                return value.split(" ")[0].replace("/", "-").replace("/", "-") + " 至 " + cell[6].split(" ")[0].replace("/", "-").replace("/", "-");
            }
            else {
                return "-";
            }
        }
        function formatDate2(value, cell) {
            if (value) {
        ...
        function formatDate3(value, cell) {
            if (value) {
                return value.split(" ")[0].replace("/", "-").replace("/", "-") + " 至 " + cell[4].split(" ")[0].replace("/", "-").replace("/", "-");
            }
            else {
