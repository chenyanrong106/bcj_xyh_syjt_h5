$(document).ready(function () {
    (function (e, t, n) {
        ...
        function l(e, t) {
            ...
            if (n.attr("data-bootstro-nextButton")) {
                ...
                if (typeof a.nextButton != "undefined") r = a.nextButton;
                else r = '<button class="btn btn-primary btn-mini bootstro-next-btn">' + a.nextButtonText + "</button>"
            }
            if (n.attr("data-bootstro-prevButton")) {
                ...
                if (typeof a.prevButton != "undefined") s = a.prevButton;
                else s = '<button class="btn btn-primary btn-mini bootstro-prev-btn">' + a.prevButtonText + "</button>"
            }
            if (n.attr("data-bootstro-finishButton")) {
                ...
                if (typeof a.finishButton != "undefined") o = a.finishButton;
                else o = '<button class="btn btn-primary btn-mini bootstro-finish-btn">' + a.finishButtonText + "</button>"
            }
            if (i != 1) {
                if (t == 0) e = e + r;
                else if (t == i - 1) e = e + s;
        ...
        get_element = function (e) {
            if (r.filter("[data-bootstro-step=" + e + "]").size() > 0) return r.filter("[data-bootstro-step=" + e + "]");
            else {
                return r.eq(e)
            }
        };
        get_popup = function (e) {
            ...
            if (t.title != "" && r != "") t.title = r + " - " + t.title;
            else if (t.title == "") t.title = r;
            ...
            t.template = '<div class="popover" style="' + s + '"><div class="arrow"></div><div class="popover-inner"><h4 class="popover-title"></h4><div class="popover-content"><p></p></div></div>' + "</div>";
            return t
        };
        ...
        e.stop = function () {
            ...
            if (typeof a.onExit == "function") a.onExit.call(this, {
                idx: o
            })
        };
        e.go_to = function (n) {
            ...
            if (i != 0) {
                ...
                var c = l - u;
                if (c < a.margin) t("html,body").animate({
                    scrollTop: l - a.margin
                },
				"slow");
                else if (!f(t(".popover.in")) || !f(s)) t("html,body").animate({
                    scrollTop: l - a.margin
                },
				"slow");
        ...
        e.next = function () {
            if (o + 1 == i) {
                if (typeof a.onComplete == "function") a.onComplete.call(this, {
                    idx: o
                })
            } else {
                e.go_to(o + 1);
                if (typeof a.onStep == "function") a.onStep.call(this, {
                    idx: o,
                    direction: "next"
                })
            }
        ...
        e.bind = function () {
            e.unbind();
            t("html").on("click.bootstro", ".bootstro-next-btn",
			function (t) {
			    e.next();
			    t.preventDefault();
			    return false
			});
            t("html").on("click.bootstro", ".bootstro-prev-btn",
			function (t) {
			    e.prev();
			    t.preventDefault();
			    return false
			});
            t("html").on("click.bootstro", ".bootstro-finish-btn",
			function (t) {
			    e.stop()
			});
            if (a.stopOnBackdropClick) {
                t("html").on("click.bootstro", "div.bootstro-backdrop",
				function (n) {
				    if (t(n.target).hasClass("bootstro-backdrop")) e.stop()
				})
            }
            t(document).on("keydown.bootstro",
			function (t) {
			    var n = t.keyCode ? t.keyCode : t.which;
			    if (n == 39 || n == 40) e.next();
			    else if (n == 37 || n == 38) e.prev();
			    else if (n == 27 && a.stopOnEsc) e.stop()
			})
        };
        e.unbind = function () {
    ...
    })(window.bootstro = window.bootstro || {},
        jQuery)
})