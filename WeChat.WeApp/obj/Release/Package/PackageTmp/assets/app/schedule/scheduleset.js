; (function (window, undefined, $) {
    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            url: options.listUrl,
            colModel: [
                    { display: '班次名称', name: 'NAME', width: "15%", sortable: true, hide: false, align: 'left', iskey: true },
                    { display: '颜色', name: 'COLOR', width: "25%", sortable: false, align: 'left',process:formatColor },
                    { display: '开始时间', name: 'BEGINTIME', width: "10%", sortable: false, align: 'left' },
                    { display: '结束时间', name: 'ENDTIME', width: "10%", sortable: false, align: 'left' },
