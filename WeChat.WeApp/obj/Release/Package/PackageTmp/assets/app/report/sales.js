        ...
        function PGRID() {
            var gridopt = {
                ...
                colModel: [
                        ...
                        { display: '原价', name: 'PROD_Sprice', sortable: false, align: 'left' },
                         { display: '数量', name: 'PROD_COUNT', sortable: false, align: 'left' },
                        { display: '金额', name: 'PROD_AMT', sortable: false, align: 'left' },
        ...
        function SGRID() {
            ...
            var gridopt2 = {
                ...
                colModel: [
                        ...
                        { display: '分店名称', name: 'STORENAME', sortable: false, align: 'left' },
                        { display: '时间', name: 'DATES', sortable: false, align: 'left' },
                        { display: '原价', name: 'SPrice', sortable: false, align: 'left' },
                        { display: '数量', name: 'SERVICE_COUNT', sortable: false, align: 'left' },
                        { display: '折扣', name: 'discount', sortable: false, align: 'left' },
                        { display: '金额', name: 'AMT', sortable: false, align: 'left' }
        ...
        function CGRID() {
            var gridopt3 = {
                ...
                colModel: [
                    ...
                    { display: '实收金额', name: 'REAL_AMT', sortable: false, align: 'left' },
                    { display: '优惠额', name: 'DIS_AMT', sortable: false, align: 'left' }
                ],
                title: false,
                rp: 10,
                usepager: true,
