    ...
    $(document).ready(function () {
        ...
        var gridopt = {
            ...
            colModel: [
                   ...
                   { display: '原价金额', name: 'OldAmt', sortable: false, align: 'left' },
                  //{ display: '折扣', name: 'BankPOS', sortable: false, align: 'left' },
                  { display: '实际金额', name: 'RealAmt', sortable: false, align: 'left' },
                  { display: '存款额', name: 'deposit', sortable: false, align: 'left' },
                  { display: '存款优惠', name: 'DisAmt', sortable: false, align: 'left' },
                  { display: '卡上余额', name: 'BALANCE', sortable: false, align: 'left' }
            ],
            sortname: "Id",
            sortorder: "ASC",
            title: false,
