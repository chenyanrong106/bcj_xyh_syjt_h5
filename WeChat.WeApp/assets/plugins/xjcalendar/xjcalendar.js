; (function (window, undefined, $) {
    ...
    */
    ...
    function __BuildItem__(theme, item, index) {
        ...
        //content.push("<div><a href='/Customer/View360.do?cid=" + item.item.Idx+ "' title='点击切换的客户360视图' class='chip-user'>", item.item.UserFullName, "</a></div>");
        var color = "";
        ...
        content.push("<div  onclick='javascript:;'><a href='/Customer/View360.do' style='color:" + color + "'>", item.item.UserFullName, "</a></div>");

        content.push("<div style='color:" + color + "'>", item.item.MobilePhone, "</div>");
        if (item.item.CusReqMasseur) {
            content.push("<div>指定技师</div>");
        }

        //content.push("<br/></br><div style='margin-bottom:0px;'>");
        //content.push("<a href='#' class='notification-order' style='background-color:red;width:50px;height:50px;'><i class='fa fa-phone'></i></a>&nbsp;&nbsp;&nbsp;");
        //content.push("<a href='#' class='notification-order'><i class='fa fa-shopping-cart'></i></a>&nbsp;&nbsp;&nbsp;");
        //content.push("<a href='#' class='notification-order'><i class='fa fa-shopping-cart'></i></a>");
        //content.push("</div>");
        //content.push("<div>");
        //content.push("<a href='#' class='notification-order'><i class='fa fa-shopping-cart'></i></a>&nbsp;&nbsp;&nbsp;");
        ...
        //{
        //    icons.push("<i class='icon-user' style='margin-right:0px'></i>");
        //}
        if (item.item.Status == 0) {
            //新预约
            icons.push("<i title='新预约' class='fa fa-github-alt' style='margin-left:0px'></i>");
        }
        if (item.item.UserCard != "0") {
            //是否会员 卡号 
            icons.push("<i title='会员' class='fa fa-bitbucket' style='margin-left:45px'></i>");//会员
        }
        p.icon = icons.join("");

        var tools = [];
        //tools.push('<div style="float:left;background-color:red;"><ul style="list-style-type:none;"><li style=" float:left;line-height:padding:0px;">开</li><li style=" float:left;padding:0px;">开</li><li style=" float:left;padding:0px;">开</li></ul>');
        //tools.push('</div>');
        //tools.push("<div style='padding:0px;float:right;margin-left:-2px;'>");
        //tools.push("<div style='background-color:;float:right;width:20px;'><i class='fa fa-indent'></i></div>");
        //tools.push("<div style='background-color:;float:right;width:20px;'><i class='fa fa-frown-o'></i></div>");
        //tools.push("<div style='background-color:;float:right;width:20px;'><i class='fa fa-phone-square'></i></div>");
        //tools.push("<br/>");
        //tools.push("<div style='background-color:;float:right;width:20px;'><i class='fa fa-pencil-square'></i></div>");
        //tools.push("<div style='background-color:;float:right;width:20px;'><i class='fa fa-search'></i></div>");
        //tools.push("<div style='background-color:;float:right;width:20px;'>开</div>");
        //tools.push("</div>");
        ...
        if (item.item.Remark != "" && item.item.Remark != null) {
            tools.push("<a title='备忘录' abbr='3' href='#'><i class='fa fa-book'></i><span style='margin-left:2px'></span></a>");
        }
        if (item.item.Source == "1") {
            tools.push("<a title='微信预约' abbr='3' href='#'><i class='fa fa-comments-o'></i><span style='margin-left:2px'></span></a>");
        }
        if (item.item.Status == "2") {
    ...
    function __ThemeControl__(d) {
        function zc(c, i) {
            ...
            var d = "";
