; (function (window, undefined, $) {
    $(document).ready(function () {
        ...
        $("#btnProd").click(function () {
            var gridopt = {
                url: options.QuerySerlistUrl+"?NAME=LEVIN",
                colModel: [
                        { display: '编号', name: 'ID', width: "5%", sortable: true, hide: true, align: 'left', iskey: true },
                        { display: '名称', name: 'NAME', width: "70%", sortable: false, align: 'left' },
                        ...
                        //{ display: '状态', name: 'STATUS', width: "7%", sortable: false, align: 'left' },
            ...
            function processOp(value, cell) {
                var ops = [];
                ops.push("&nbsp;&nbsp;<a title='添加' class='abtn' href='javascript:;'  onclick=\"util.Delete('", value, "','", cell[1], "')\"><i class='fa fa-plus' ></i>添加</a>");
