<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sq3.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.sq3" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="choukuan-box">
            <ul>
                ...
                <li>
                    <input name="" type="text" id="jd" maxlength="25" class="txt2" placeholder="填写基地名称"></li>
                <li>
                    <input name="" type="text" id="Text1" class="txt2" placeholder="填写结束日期" value="<%=DateTime.Now.AddDays(12).ToString("yyyy-MM-dd") %>"></li>
                <li>
                    <input name="" type="text" id="Text2" maxlength="25" class="txt2" placeholder="填写发起人"></li>
                <li>
                    <input name="" type="text" id="Text3" maxlength="25" class="txt2" placeholder="填写接收人"></li>
                ...
                <li>请选择众筹方式：&nbsp;&nbsp;<input type="radio" name="jztype" value="1" checked="checked" />捐粮&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="jztype" value="2" />捐钱</li>
            </ul>
            <ul>
                <li><span class="uploadtxt">上传筹粮宠物照片</span>
                    <div style="position: relative; width: 100%; display: block; overflow: hidden; padding: 10px 0;">
                        ...
                        <div class="upload_btn">
                            <input type="file" id="upload_image" name="upload_image" value="图片上传"   onchange="FileUpload_onselect()"></div>
                    </div>
                </li>
                <li><span class="uploadtxt">上传头像</span>
                    <div style="position: relative; width: 100%; display: block; overflow: hidden; padding: 10px 0;">
                        <ul id="imglist2" class="post_imglist"></ul>
                        <div class="upload_btn">
                            <input type="file" id="upload_image2" name="upload_image2" value="图片上传"   onchange="FileUpload_onselect2()"></div>
                    </div>
                </li>
                <li>
...
<script type="text/javascript">
    ...
    $(".paybtn").click(function () {
        ...
        //else if (pic2 == "") {
        //    //alert("请上传至少一张照片");
        //    $.MsgBox.Alert("爱宠筹", "请上传头像");
        //}

        else {
            $(".paybtn").hide();
            $.post("sq3.aspx?para=tj", {
                mb: $("#mb").val(),
                bt: $("#bt").val(),
                xq: $("#xq").val(),
                jd: $("#jd").val(),
