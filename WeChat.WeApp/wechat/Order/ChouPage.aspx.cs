...
{
    public partial class ChouPage : WeiPage
    {
        ...
        //public List<Pet_JiuZhu_Info> njlist = new List<Pet_JiuZhu_Info>();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["para"] == null)
            {
                ...
                //njlist = nvbo.GetNewJiuZhuInfoList();
            }
            else
            {
                string html = "";
                List<Pet_JiuZhu_Info_EX> jlist = nvbo.GetJiuZhuInfoList(int.Parse(Request.Params["page"]), int.Parse(Request.Params["jztype"]));
