<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SC2.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.SC2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>手工小鲜粮优先试吃权—PETKIN宠物管家</title>
...
<body>
    ...
    <div class="main">
  <div class="txtcon">
    <p>PETKIN手工小鲜粮是一个互联网产品，<br>
因为管家一直希望宝贝狗狗可以有<br/>
<strong>更好更健康的选择！</strong></p>
    <h2>点评网试吃通道&nbsp;<bdo  id="btnid"><input name="" type="button" class="btn" value="开抢" id="btn"></bdo></h2>
  </div>
