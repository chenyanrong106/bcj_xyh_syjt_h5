        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((Request.QueryString["FromUserName"] != null || Session["FromUserName"] != null) && (Request.QueryString["ToUserName"] != null || Session["ToUserName"] != null))
            {
                ...
                else
                {
                    ...
                    string html = "";
                    List<MyJiuZhu> mlist = nvbo.GetMyStarJiuZhuList(user, int.Parse(Request.Params["type"]), int.Parse(Request.Params["page"]));
                    foreach (var m in mlist)
                    {
                            html += string.Format(@"<li><a href=""detail.aspx?id={0}&p={5}"">
                        <div class=""imgbox"">
                            <img src=""{1}"">
                        </div>
                        <div class=""jiluinfo"">
                    ...
                    </li>",m.ID, WebUrl + m.CImg, m.NickName, m.EndTime.ToString("yyyy.MM.dd"),m.EndTime<DateTime.Now?0:(m.EndTime-DateTime.Now).Days+1,Request.Params["p"]);
                    }
                    Response.Write(html);
                    Response.End();
                }
