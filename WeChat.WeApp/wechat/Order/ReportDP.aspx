<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportDP.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.ReportDP" %>
       ...
       <h1>单篇排行</h1> 
        <div class="petchat" style="padding-top:0;">
            <%
                ...
                {
            %>
            <a href="Detail.aspx?id=<%=l.ID %>">
            <div class="petliang2" style="border-bottom:0;">
                <ol>
                    <p><span></span><strong>标题：<%=l.Title %><em></em></strong></p>
                </ol>
            </div>
                <div class="petliang2" style="border-bottom:0;">
                <ol>
                    <p><span></span><strong>基地：<%=l.NickName %><em></em></strong></p>
                </ol>
            </div>
            <div class="petliang2" style="border-bottom:0;">
                <ol>
                    <p><span></span><strong>￥<%=l.je %><em><%=l.JZType==1?"筹粮":"筹款" %><%=l.JZType==1?"（"+Math.Round(l.je.Value/16,2)+"Kg)":"" %></em></strong></p>
                </ol>
            </div>
            <div class="petliang2">
                <ol>
                    <p><span></span><strong>结束时间：<%=l.EndTime.Value.ToString("yyyy.MM.dd") %><em></em></strong></p>
                </ol>
            </div></a>
            <%  } %>
        </div>
