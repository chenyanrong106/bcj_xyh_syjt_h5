<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhifu3.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.Zhifu3" %>
    ...
    <form id="form1" runat="server">
        <div class="address">
            <p runat="server" id="addinfo">
                <bdo class="zuobiao"></bdo><a href="address.aspx">您还没有默认的收货信息<br />
                    立即新增</a>
            </p>
        </div>
        ...
        <div class="orderbox">
            <ul>
                <li>
                    <p><span><em><a href="javascript:jian(1);">-</a></em><input name="" type="number" class="shutxt" size="6" value="0" id="carnum1"><em><a href="javascript:add(1);">+</a></em></span><b>牛肉配方</b><bdo>1.5kg（100g*15袋）</bdo></p>
                    <p id="danpin1"><span>小计：<strong>0元</strong></span>单价：<i>90</i></p>
                </li>
                <li>
                    <p><span><em><a href="javascript:jian(2);">-</a></em><input name="" type="number" class="shutxt" size="6" value="0" id="carnum2"><em><a href="javascript:add(2);">+</a></em></span><b>三文鱼配方</b><bdo>1.5kg（100g*15袋）</bdo></p>
                    <p id="danpin2"><span>小计：<strong>0元</strong></span>单价：<i>90</i></p>
                </li>
                <li>
                    <p><span><em><a href="javascript:jian(3);">-</a></em><input name="" type="number" class="shutxt" size="6" value="0" id="carnum3"><em><a href="javascript:add(3);">+</a></em></span><b>牛肉配方</b><bdo>5.0kg（250g*20袋）</bdo></p>
                    <p id="danpin3"><span>小计：<strong>0元</strong></span>单价：<i>240</i></p>
                </li>
                <li>
                    <p><span><em><a href="javascript:jian(4);">-</a></em><input name="" type="number" class="shutxt" size="6" value="0" id="carnum4"><em><a href="javascript:add(4);">+</a></em></span><b>三文鱼配方</b><bdo>5.0kg（250g*20袋）</bdo></p>
                    <p id="danpin4"><span>小计：<strong>0元</strong></span>单价：<i>240</i></p>
                </li>
            </ul>
        </div>
        <div class="orderbox">
            <ul>
               <%-- <li><span>
                ...
                <div class="shurubox"><span>
                    <input name="" type="button" class="btnphone" value="使用"></span><input name="" type="number" class="shutxt"  id="yhq" style="width: 70%; text-indent: 10px; line-height: 40px; height: 40px; text-align: left; font-size: 16px; border: none;" placeholder="如有优惠码请输入" onchange="change(this);" onkeydown="change(this);" onkeyup="change(this);"></div>
               
                <input type="hidden" id="yhqid" value="0" />
                <input type="hidden" id="yhqzk" value="1" />
        ...
        <div class="zhifubtn" id="price">
            <ol><span>￥<bdo runat="server" id="dj">0</bdo>  <em id="sl" style="display: none;">1</em></span>鲜粮金额</ol>
...
<script type="text/javascript">
    ...
    function jian(id) {
        ...
        if (id == 1 || id == 2) {
            danpinzong.innerHTML = 90 * num + '元';
        }
        else {
            danpinzong.innerHTML = 240 * num + '元';
        }
        chengji();
    }
    function add(id) {
    ...
    function chengji() {
        $("#dj").html($("#carnum1").val() * 90 + $("#carnum2").val() * 90 + $("#carnum3").val() * 240 + $("#carnum4").val() * 240);
        var jiage = document.getElementById('price').getElementsByTagName('bdo');
        document.getElementById('price').getElementsByTagName('em')[0].innerHTML = parseInt($("#carnum1").val()) + parseInt($("#carnum2").val()) + parseInt($("#carnum3").val()) + parseInt($("#carnum4").val());
        ...
        if ($("#yhqid").val() == "0") {
            ...
            $("#yh").html((socre-socre * parseFloat($("#yhqzk").val())).toFixed(2));
    ...
    $("#tjdd").click(function () {
        if ($("#isadd").val() == "0") {
            ...
            if ($("#yhqid").val() == "0" && $("#yhq").val().length == 11) {
                $.MsgBox.Alert("宠物半湿粮", "请点击‘使用’按钮验证优惠券是否可使用，如果不准备使用优惠券，请删除优惠券券号。");
            }
            else {
                $.post("zhifu3.aspx?para=tj", {
                                         ...
                                         if (ret.st == -1) {
                                             ...
                                             wx.chooseWXPay({
                                                 ...
                                                 complete: function (ret) {
                                                     ...
                                                     else { $.MsgBox.Alert("宠物半湿粮", "网络异常，请刷新后重试"); }
                                                 }
                                             });
                                         }
                                     },
