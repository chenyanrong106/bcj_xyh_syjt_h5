<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhifu8.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.Zhifu8" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="orderbox">
            <ul>
                ...
                <div class="shurubox">
                    <span>
                        <input name="" type="button" class="btnphone" value="使用"></span><input name="" type="number" class="shutxt" id="yhq" style="width: 70%; text-indent: 10px; line-height: 40px; height: 40px; text-align: left; font-size: 16px; border: none;" placeholder="如有优惠码请输入" onchange="change(this);" onkeydown="change(this);" onkeyup="change(this);">
                </div>
