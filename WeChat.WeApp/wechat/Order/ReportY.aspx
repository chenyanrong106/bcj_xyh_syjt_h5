<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportY.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.ReportY" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="petchat">
            <div class="petliang2">
                <ol>
                    <p><span>月份</span><strong><em></em></strong></p>
                </ol>
                <ol>
                    <p><span>总计</span><strong><em></em></strong></p>
                </ol>
                <ol>
            ...
            <div class="petliang2">
                <ol>
                    <p><span></span><strong><%=l.rq.Length>=6?l.rq.Substring(2,4):l.rq %><em></em></strong></p>
                </ol>
                <ol>
            ...
            <%-- <div class="petliang2">
                <ol>
                    <p><span></span><strong>总<em></em></strong></p>
                </ol>
                <ol>
                    <p><span></span><strong><%=zje %><em></em></strong></p>
                </ol>
                <ol>
                    <p><span></span><strong><%=zwx %><em></em></strong></p>
                </ol>
                <ol>
                    <p><span></span><strong><%=zzfb %><em></em></strong></p>
                </ol>
            </div>--%>
        </div>
