<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditChou.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.EditChou" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="navbar">
            <div class="tabbar">
                ...
                <%} else{ %>
                <span><a href="javascript:;" onclick="cl(0);">发起筹粮</a></span>
                <span><a href="javascript:;" onclick="cl(1);" class="on">发起筹款</a></span>
                <%} %>
            </div>
        </div>
        ...
        <div class="acc-login-input faqibg">
            <ul style="padding: 0; margin-bottom: 10px;">
                ...
                <li>
                    <p><strong id="titmb">目标狗粮</strong><span><input name="" type="number" id="mb" class="txt" maxlength="20" placeholder="填写目标" style="width: 90%; float: left;" value="<%=jz.Goal %>"><bdo class="jiage">KG</bdo></span></p>
                </li>
                <li>
                ...
                <li>
                    <p class="huakuai">
                        <bdo id="beginid">1天</bdo><bdo class="huakuaicon">
        ...
        <div class="acc-login-input baibg">
            <ul style="padding: 0; margin-bottom: 10px;">
                ...
                <li>
                    <p><strong>筹款标题</strong><span><input name="" type="text" id="bt" class="txt" maxlength="50" placeholder="填写标题" value="<%=jz.Title %>"></span></p>
                </li>
                 <li>
                    <p><strong>上线时间</strong><span><input name="" type="text" id="txtbegtime" class="txt" maxlength="50" placeholder="上线时间" value="<%=jz.BegTime==null?DateTime.Now.ToString("yyyy-MM-dd"):jz.BegTime.Value.ToString("yyyy-MM-dd") %>"></span></p>
                </li>
                <li>
                    <p>
                        <textarea name="" cols="" id="xq" rows="" class="dropdown-area" placeholder="详细描述
(建议详细描述保护动物情况：如动物特殊情况介绍／申请动物保护理由等。)"><%=jz.Detail %></textarea>
                    </p>
                </li>
                <li>
        ...
        <div class="acc-login-input baibg">
            <div class="acc-upload-box">
                ...
                <p class="upload-info" style="color:red;font-size:larger;">如果图片不需要修改，则不用上传任何图片，如果需要修改修改图片，则需要上传所有图片，包括不需要修改的图片。</p>
            </div>
        </div>
        ...
        <div class="acc-login-input baibg">
            <div class="acc-upload-box">
                ...
                <div style="position: relative; width: 100%; display: block; overflow: hidden; padding: 10px 0;">
                    ...
                    <div class="upload_btn">
                        <input type="file" id="upload_image2" name="upload_image2" value="图片上传"  onclick="FileUpload_onclick2()" onchange="FileUpload_onselect2()">
                    </div>
                </div>
        ...
        <input type="hidden" id="endtime" value="<%=jz.EndTime.Value.ToString("yyyy-MM-dd") %>" />
        <input type="hidden" id="syts" value="<%=(jz.EndTime.Value-DateTime.Now).Days %>" />
...
<script type="text/javascript">
    ...
    var i = beginzhi;
    dayzhi($("#syts").val());
    document.getElementById('yellowkuai').style.width = ($("#syts").val() * 10 + 10) + 'px';
    document.getElementById('tuobtn').style.left = $("#syts").val() * 10 + 'px';
