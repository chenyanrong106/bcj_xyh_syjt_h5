<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuanZhu.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.GuanZhu" %>
...
<script type="text/javascript">
    ...
    function getList(n) {
        ...
        $.ajax({
            type: "get",
            url: "guanzhu.aspx?para=tj&page=" + n + "&type=" + type + "&p=" + $("#urlpara").val(),
