<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Address41.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.Address41" %>
        ...
        if ($("#xm").val() == "") {
            ...
            $.post("Address41.aspx?para=tj", {
                ...
                address: $("#address").val()
                                ...
                                function (ret) {
                                    if (ret == "ok") {
                                        $.MsgBox.Alert("宠物管家", ret, function () { location = "zhifu41.aspx"; });
                                    }
                                    else {
