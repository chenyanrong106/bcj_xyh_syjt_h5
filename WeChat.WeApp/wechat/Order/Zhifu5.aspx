<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhifu5.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.Zhifu5" %>
...
<div class="orderbox">
  <ul>
     <li><h2>PETKIN 手工半湿粮（100g）*3包</h2></li>
...
<div class="zhifubtn" id="price">
  <ol><span>￥<bdo>19.9</bdo> × <em>1</em></span>湿粮金额</ol>
  <ol><span>￥<bdo runat="server" id="yh">0.00</bdo></span>优惠金额</ol>
  <ol><span style="color:#999;">￥<bdo>0.00</bdo></span>邮费</ol>
  <br>
  ...
  <div class="btn" id="tjdd" runat="server">提交订单</div>
    ...
    <div style="color:gray;font-size:small;text-align:center;"> (此活动仅限于上海地区,每人仅限购买一份。)</div>
</div>
