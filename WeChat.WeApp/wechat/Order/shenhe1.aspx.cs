...
{
    public partial class shenhe1 : WeiPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["para"] == null)
            {
                ...
                njlist = nvbo.GetNewJiuZhuInfoList(0);
                //jlist = nvbo.GetJiuZhuInfoList();
            }
            else
            {
                string html = "";
                List<Pet_JiuZhu_Info> jlist = nvbo.GetJiuZhuInfoListForSH(int.Parse(Request.Params["page"]));
                foreach (Pet_JiuZhu_Info o in jlist)
                {
                    if (o.JZType == 1)
                        html += string.Format(@"<li onclick=""window.location='shenhe2.aspx?id={0}&p={12}'"">
                        <div class=""adminInfo"">
                            <p>
...
//                            <ol><span class=""jindu"">进度:<b {11}>{9}</b>%</span></ol>
//                        </div>
//                    </li>", o.ID, o.HeadImage, o.NickName, (o.EndTime > DateTime.Now ? "进行中" : "已结束"), o.Title, (o.Detail.Length > 50 ? o.Detail.Substring(0, 50) + "..." : o.Detail), o.rc, o.Goal, o.je.Value, Math.Round(o.je.Value / o.Goal.Value * 100m, 2), GetImgs(o), o.je > o.Goal ? "style='color:red;'" : "", Request.QueryString["p"]);
//                }
                Response.Write(html);
                Response.End();
            }
