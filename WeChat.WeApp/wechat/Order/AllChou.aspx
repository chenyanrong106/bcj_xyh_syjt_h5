<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllChou.aspx.cs" Inherits="SPACRM.WebApp.wechat.Order.AllChou" %>
...
<script>
    ...
    function showPetdata() {
        $.ajax({
            type: "Get",
            url: "allchou.aspx?para=tj&page=" + pageNum + "&p=" + $("#urlpara").val(),
            dataType: 'html',
            async: false,
            beforeSend: function () {
                isLoading = true;
